...
const DATA = {
    navbar: [
        ...
        { href: "https://www.researchgate.net/scientific-contributions/Wesley-Leeroy-2338827419", icon: Icons.researchgate, label: "ResearchGate" },
    ],
    contact: {
        social: {
            GitHub: {
                name: "GitHub",
                url: "https://github.com/wesleyleeroy",
                icon: Icons.github,
            },
            LinkedIn: {
                name: "LinkedIn",
                url: "https://www.linkedin.com/in/wesley-leeroy/",
                icon: Icons.linkedin,
            },
            Instagram: {
                name: "Instagram",
                url: "https://www.instagram.com/wesleyleeroy/",
...
export default function DockDemo() {
    return (
        <div className="flex justify-center py-8">
            <Dock direction="middle" className="bg-white/50 backdrop-blur-md border-gray-200/30 shadow-xl">
